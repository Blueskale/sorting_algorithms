...
/**
 * bitonic_compare - helper function to bitonic_merge
 * sorts contents of the current subarray in the given order
 * @up: if true, sort in ascending order, false, sort in descending order
...
/**
 * bitonic_sort_r - first recursive function of bitonic_sort, divides array
